...
const person1 = {
  name: "John Smith",
  trashTalk:
    "You think you can beat me? I've been rolling dice since before you were born!",
  image:
    "https://i.pinimg.com/564x/df/11/28/df11287e5e7dec8a886b4a9f7cb6445f.jpg",
...
const person2 = {
  name: "David Johnson",
  trashTalk:
    "Luck is a fickle mistress, my friend, and today she's on my side.",
  image:
...
const person3 = {
  ...
  image:
    "https://i.pinimg.com/736x/51/20/06/51200671de062fe0d2df9b102385e688.jpg",
...
const person4 = {
  name: "Robert Martin",
  trashTalk:
    "In this game, there are winners and there are the ones who wish they were winners. Which one are you?",
  image:
    "https://i.pinimg.com/564x/5a/aa/5a/5aaa5ace1ad94bb8a06169b7b27ddfc2.jpg",
...
const person5 = {
  ...
  trashTalk:
    "I hope you've been practicing, because you're about to witness the art of dice mastery.",
  image:
...
const person7 = {
  ...
  trashTalk:
    "I can hear the dice calling my name. Can you hear them calling yours?",
  image:
...
function rollDice() {
  ...
  var speedBoost =
    localStorage.getItem("speed_boost") === null
      ? "false"
      : localStorage.getItem("speed_boost");
...
function compareDices() {
  ...
  var streakBonus =
    localStorage.getItem("streak_bonus") === null
      ? "false"
  ...
  var percentageBoost =
    localStorage.getItem("percentage_boost") === null
      ? "false"
  ...
  if (playerDice > personDice) {
      if (streak >= 1) {
        var streakAmount =
          (Math.floor(Math.random() * 500) + 50) * streak +
    ...
    if (percentageBoost === "true") {
      ...
      Percetmsg = `<br/>Percentage Boost: (${percentWon}% boost)`;
    }
    var msg = `You rolled ${playerDice}, ${
      randomPerson.name
    } rolled a ${personDice}. You won! + ${
      percentageBoost === "true" || streakBonus === "true"
    ...
    gameResult.innerHTML =
      msg +
      (percentageBoost === "true" ? Percetmsg : "") +
      (streakBonus === "true" && streak >= 1 ? streakBoostmsg : "<br/>"); // MESSAGE RETURNS UNDEFINED. (FIX)
